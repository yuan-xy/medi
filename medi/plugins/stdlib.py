...
from medi._compatibility import force_unicode, Parameter
from medi import debug
from medi.inference.utils import safe_property
from medi.inference.helpers import get_str_or_none
from medi.inference.arguments import iterate_argument_clinic, ParamIssue, \
    repack_with_argument_clinic, AbstractArguments, TreeArgumentsWrapper
from medi.inference import analysis
from medi.inference import compiled
from medi.inference.value.instance import \
    AnonymousMethodExecutionContext, MethodExecutionContext
from medi.inference.base_value import ContextualizedNode, \
    NO_VALUES, ValueSet, ValueWrapper, LazyValueWrapper
from medi.inference.value import ClassValue, ModuleValue
from medi.inference.value.klass import ClassMixin
from medi.inference.value.function import FunctionMixin
from medi.inference.value import iterable
from medi.inference.lazy_value import LazyTreeValue, LazyKnownValue, \
    LazyKnownValues
from medi.inference.names import ValueName, BaseTreeParamName
from medi.inference.filters import AttributeOverwrite, publish_method, \
    ParserTreeFilter, DictFilter
from medi.inference.signature import AbstractSignature, SignatureWrapper
...
def collections_namedtuple(value, arguments, callback):
    ...
    # Process arguments
    name = u'medi_unknown_namedtuple'
