"""
Recursions are the recipe of |medi| to conquer Python code. However, someone
must stop recursions going mad. Some settings are here to make |medi| stop at
the right time. You can read more about them :ref:`here <settings-recursion>`.

Next to the internal ``medi.inference.cache`` this module also makes |medi| not
...
The default values are based on experiments while completing the |medi| library
...
from medi.inference.base_value import NO_VALUES


recursion_limit = 15
"""
Like :func:`sys.getrecursionlimit()`, just for |medi|.
"""
