...
from medi.inference.value.klass import ClassFilter
from medi.inference.value.klass import ClassMixin
from medi.inference.utils import to_list
from medi.inference.names import AbstractNameDefinition, ValueName
    ...
    def infer(self):
        def iter_():
            for value in self._value_set:
                ...
                from medi.inference.gradual.typing import AnyClass
