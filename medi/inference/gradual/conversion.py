...
from medi.inference.gradual.stub_value import StubModuleValue
from medi.inference.gradual.typeshed import try_to_load_stub_cached
...
def _infer_from_stub(stub_module_context, qualified_names, ignore_compiled):
    from medi.inference.compiled.mixed import MixedObject
