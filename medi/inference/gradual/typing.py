...
from medi.inference.compiled import builtin_from_name, create_simple_object
from medi.inference.base_value import ValueSet, NO_VALUES, Value, \
    LazyValueWrapper
from medi.inference.lazy_value import LazyKnownValues
from medi.inference.arguments import repack_with_argument_clinic
from medi.inference.filters import FilterWrapper
from medi.inference.names import NameWrapper, ValueName
from medi.inference.value.klass import ClassMixin
from medi.inference.gradual.base import BaseTypingValue, \
    BaseTypingClassWithGenerics, BaseTypingInstance
from medi.inference.gradual.type_var import TypeVarClass
...
class TypeAlias(LazyValueWrapper):
    ...
    def _get_wrapped_value(self):
        ...
        from medi.inference.imports import Importer
        module, = Importer(
...
class Tuple(BaseTypingInstance):
    ...
    def infer_type_vars(self, value_set):
        # Circular
        from medi.inference.gradual.annotation import merge_pairwise_generics, merge_type_var_dicts
...
class NewType(Value):
    ...
    @property
    def name(self):
        from medi.inference.compiled.value import CompiledValueName
