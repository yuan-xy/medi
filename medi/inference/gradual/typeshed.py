...
from medi._compatibility import FileNotFoundError, cast_path
from medi.parser_utils import get_cached_code_lines
from medi.inference.base_value import ValueSet, NO_VALUES
from medi.inference.gradual.stub_value import TypingModuleWrapper, StubModuleValue
from medi.inference.value import ModuleValue

_medi_path = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
TYPESHED_PATH = os.path.join(_medi_path, 'third_party', 'typeshed')
DJANGO_INIT_PATH = os.path.join(_medi_path, 'third_party', 'django-stubs',
