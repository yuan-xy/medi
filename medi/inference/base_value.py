...
static analysis operation. In medi there are always multiple returns and not
just one.
"""
...
from medi._compatibility import zip_longest, unicode
from medi.parser_utils import clean_scope_docstring
from medi.inference.helpers import SimpleGetItemNotFound
from medi.inference.utils import safe_property
from medi.inference.cache import inference_state_as_method_param_cache
...
class HelperValueMixin(object):
    ...
    def execute_with_values(self, *value_list):
        from medi.inference.arguments import ValuesArguments
...
class ValueSet(object):
    ...
    def iterate(self, contextualized_node=None, is_async=False):
        from medi.inference.lazy_value import get_merged_lazy_value
    ...
    def infer_type_vars(self, value_set):
        # Circular
        from medi.inference.gradual.annotation import merge_type_var_dicts
