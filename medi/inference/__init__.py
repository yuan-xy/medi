...
* The programmer is not a total dick, e.g. like `this
  <https://github.com/davidhalter/medi/issues/24>`_ :-)
...
TODO this paragraph is not what medi does anymore, it's similar, but not the
same.
...
from medi.inference.syntax_tree import infer_expr_stmt, \
