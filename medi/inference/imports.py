"""
:mod:`medi.inference.imports` is here to resolve import statements and return
...
from medi._compatibility import ImplicitNSInfo, force_unicode, FileNotFoundError
from medi import debug
from medi import settings
from medi.file_io import FolderIO
from medi.parser_utils import get_cached_code_lines
from medi.inference import sys_path
from medi.inference import helpers
...
from medi.inference.names import ImportName, SubModuleName
from medi.inference.base_value import ValueSet, NO_VALUES
from medi.inference.gradual.typeshed import import_module_decorator, \
...
def import_module(inference_state, import_names, parent_module_value, sys_path):
    ...
    if isinstance(file_io_or_ns, ImplicitNSInfo):
        from medi.inference.value.namespace import ImplicitNamespaceValue
