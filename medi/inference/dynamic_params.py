"""
One of the really important features of |medi| is to have an option to
...
from medi.parser_utils import get_parent_scope
...
from medi.inference.helpers import is_stdlib_path
from medi.inference.utils import to_list
from medi.inference.value import instance
from medi.inference.base_value import ValueSet, NO_VALUES
from medi.inference.references import get_module_contexts_containing_name
...
def _check_name_for_execution(inference_state, context, compare_node, name, trailer):
    from medi.inference.value.function import BaseFunctionExecutionContext
    ...
    def create_args(value):
        ...
        from medi.inference.value.instance import InstanceArguments
