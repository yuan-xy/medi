...
from medi._compatibility import force_unicode, is_py3
from medi.inference import compiled
from medi.inference import analysis
from medi.inference.lazy_value import LazyKnownValue, LazyKnownValues, \
    LazyTreeValue
from medi.inference.helpers import get_int_or_none, is_string, \
    reraise_getitem_errors, SimpleGetItemNotFound
from medi.inference.utils import safe_property, to_list
from medi.inference.cache import inference_state_method_cache
from medi.inference.filters import LazyAttributeOverwrite, publish_method
from medi.inference.base_value import ValueSet, Value, NO_VALUES, \
    ContextualizedNode, iterate_values, sentinel, \
    LazyValueWrapper
from medi.parser_utils import get_sync_comp_fors
from medi.inference.context import CompForContext
from medi.inference.value.dynamic_arrays import check_array_additions
...
class DictComprehension(ComprehensionMixin, Sequence, _DictKeyMixin):
    ...
    def exact_key_items(self):
        ...
        # completions, but at least like this medi doesn't crash
        return []
