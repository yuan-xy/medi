...
from medi.inference import recursion
from medi.inference import docstrings
from medi.inference import flow_analysis
from medi.inference.signature import TreeSignature
from medi.inference.filters import ParserTreeFilter, FunctionExecutionFilter, \
    AnonymousFunctionExecutionFilter
from medi.inference.names import ValueName, AbstractNameDefinition, \
    AnonymousParamName, ParamName, NameWrapper
from medi.inference.base_value import ContextualizedNode, NO_VALUES, \
    ValueSet, TreeValue, ValueWrapper
from medi.inference.lazy_value import LazyKnownValues, LazyKnownValue, \
    LazyTreeValue
from medi.inference.context import ValueContext, TreeContextMixin
from medi.inference.value import iterable
from medi import parser_utils
from medi.inference.parser_cache import get_yield_exprs
from medi.inference.helpers import values_from_qualified_names
from medi.inference.gradual.generics import TupleGenericManager
...
class FunctionExecutionContext(BaseFunctionExecutionContext):
    ...
    def _infer_annotations(self):
        from medi.inference.gradual.annotation import infer_return_types
