...
:mod:`medi.inference.dynamic_params` tries to find all executions of functions,
while the docstring parsing is much easier. There are three different types of
docstrings that |medi| understands:
...
from medi.inference.base_value import iterator_to_value_set, ValueSet, \
    NO_VALUES
