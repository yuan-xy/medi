"""
This module contains variables with global |medi| settings. To change the
behavior of |medi|, change the variables defined in :mod:`medi.settings`.
...
auto_import_modules = [
    'gi',  # This third-party repository (GTK stuff) doesn't really work with medi
]
"""
