...
from medi.inference.imports import ImportName
from medi.inference.compiled.mixed import MixedName
...
from medi.api import completion_cache
from medi.api.helpers import filter_follow_imports
...
class BaseName(object):
    ...
    def infer(self, **kwargs):  # Python 2...
        ...
        your completions, because it might slow down |medi|. If you want to
