...
from medi._compatibility import force_unicode, cast_path, is_py3
from medi.parser_utils import get_executable_nodes
...
from medi.api import interpreter
...
from medi.api.refactoring.extract import extract_function, extract_variable
from medi.inference import InferenceState
from medi.inference import imports
from medi.inference.references import find_references
from medi.inference.arguments import try_iter_content
from medi.inference.helpers import infer_call_of_leaf
from medi.inference.sys_path import transform_path_to_dotted
...
from medi.inference.value.iterable import unpack_tuple_to_dict
from medi.inference.gradual.conversion import convert_names, convert_values
...
class Script(object):
    ...
    .. warning:: By default :attr:`medi.settings.fast_parser` is enabled, which means
        ...
        `this discussion <https://github.com/davidhalter/medi/issues/1240>`_.
    ...
    def get_syntax_errors(self):
        ...
        """
        return marso_to_medi_errors(self.grammar, self._module_node)
