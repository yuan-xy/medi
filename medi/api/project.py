...
from medi._compatibility import FileNotFoundError, PermissionError, \
    IsADirectoryError, NotADirectoryError
from medi import debug
from medi.api.environment import get_cached_default_environment, create_environment
from medi.api.exceptions import WrongVersion
from medi.api.completion import search_in_module
from medi.api.helpers import split_search_string, get_module_names
...
from medi.inference.sys_path import discover_buildout_paths
from medi.inference.cache import inference_state_as_method_param_cache
from medi.inference.references import recurse_find_python_folders_and_files, search_in_file_ios
...
class Project(object):
    ...
    def load(cls, path):
        ...
        to ``.medi/project.json``, but rather the path to the project folder.
    ...
    def save(self):
        """
        Saves the project configuration in the project in ``.medi/project.json``.
        """
    ...
    def _get_sys_path(self, inference_state, add_parent_paths=True, add_init_paths=False):
        """
        Keep this method private for all users of medi. However internally this
